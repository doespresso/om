 ...
 */
$GLOBALS['sb_db_database'] = 'omiscranes_ru';
...
$GLOBALS['sb_domains']['omiscranes.ru'] = array();
$GLOBALS['sb_domains']['omiscranes.ru']['basedir'] = '/Users/jd/servers/LOCALHOST/omiskrans.ru/public';
$GLOBALS['sb_domains']['omiscranes.ru']['ftp_host'] = 'local';
$GLOBALS['sb_domains']['omiscranes.ru']['ftp_basedir'] = '';
$GLOBALS['sb_domains']['omiscranes.ru']['ftp_user'] = '';
$GLOBALS['sb_domains']['omiscranes.ru']['ftp_password'] = '';
$GLOBALS['sb_domains']['omiscranes.ru']['pointers'] = array('omiscranes.ru');
