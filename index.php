...
<html lang="ru">
  <head>
    ...
    <title>OMIS. Краны и подъемные системы</title>
...
<div class="row wrapper-top"><?php include_once SB_CMS_PL_PATH.'/pl_plugin_maker/prog/pl_plugin_maker.php';
        ...
        ?></div>
<div class="row wrapper-top"><a href="#feedback" class="btn btn-primary btn-lg">отправить запрос</a></div>
<div class="row wrapper-top">ООО "ОМИС-КРАН".<br/>Российское представительство компании OMIS<br>Москва, ул. Большая Очаковская 47А стр.1<br/>+7 495 778-32-36</div>
</div>
</div>
</div>
</section>
